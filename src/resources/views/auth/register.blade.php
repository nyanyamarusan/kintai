...
<div class="container inter text fw-bold">
    ...
    <form action="/register" class="w-50 mx-auto" method="post">
        ...
        <div class="mt-5p">
            ...
            <input type="text" class="form-control rounded-1 border-black h-2_98vw"
                id="name" name="name">
            @error('name')
        ...
        <div class="mt-5p">
            ...
            <input type="email" class="form-control rounded-1 border-black h-2_98vw"
                id="email" name="email">
            @error('email')
                <p class="text-danger">{{ $message }}</p>
            @enderror
        ...
        <div class="mt-5p">
            ...
            <input type="password" class="form-control rounded-1 border-black h-2_98vw"
